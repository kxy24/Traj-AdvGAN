...
> **Reproducibility note.** This repository is a cleaned, manuscript-aligned release reconstructed from the preserved experimental scripts. The architecture, main loss terms, clean-box ASR definition, and principal hyperparameters are represented here. Exact paper numbers additionally depend on the original victim-detector implementations/weights, dataset splits, training schedule, random state, and checkpoints.
...
1. Base: no trajectory guidance, no channel attention
2. + trajectory guidance
3. Full: trajectory guidance + channel attention
